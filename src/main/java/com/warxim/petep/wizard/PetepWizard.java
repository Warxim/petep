...
import com.warxim.petep.gui.PetepApplication;
...
public final class PetepWizard extends PetepApplication {
  ...
  public void start(Stage stage) {
    ...
    StyleManager.getInstance()
        .addUserAgentStylesheet(getClass().getResource("/css/Main.css").toString());

    // Load wizard GUI.
    try {
      FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/wizard/Wizard.fxml"));
