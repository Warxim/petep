...
/** TCP proxy module. */
public final class TcpProxyModuleFactory extends ProxyModuleFactory
    implements Configurator<TcpConfig>, ProxyDeserializer, ProxySerializer {
  ...
  public PDU deserializePdu(
    ...
    return new TcpPdu(proxy, connection, destination, buffer, size, tags);
  }
}
