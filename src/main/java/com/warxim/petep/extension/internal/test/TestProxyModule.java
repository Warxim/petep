...
public final class TestProxyModule extends ProxyModule implements Configurable<TestProxyConfig> {
  private TestProxyConfig config;

  public TestProxyModule(
  ...
  public Proxy createProxy(PetepHelper helper) {
    return new TestProxy(this, helper, config);
  }

  @Override
  public TestProxyConfig saveConfig() {
    return config;
  }

  @Override
  public void loadConfig(TestProxyConfig config) {
    this.config = config;
  }
}
