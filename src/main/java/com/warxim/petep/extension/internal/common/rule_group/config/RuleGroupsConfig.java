...
public final class RuleGroupsConfig<R extends Rule> {
  private final List<RuleGroup<R>> groups;

  /** Rule groups configuration constructor. */
  public RuleGroupsConfig(List<RuleGroup<R>> groups) {
    this.groups = groups;
  }

  public final List<RuleGroup<R>> getRuleGroups() {
    return groups;
  }
}
